...
Begin VB.Form FormInputNumber 
   ...
   MaxButton       =   0   'False
   MinButton       =   0   'False
   MouseIcon       =   "FormInputNumber.frx":23D2
   ...
   Begin VB.CommandButton CmdDelete 
      ...
      Height          =   600
      Left            =   3990
      MouseIcon       =   "FormInputNumber.frx":2524
      MousePointer    =   99  'Custom
      TabIndex        =   16
      Top             =   4935
      Width           =   1905
   ...
   Begin VB.CommandButton CmdCancel 
      ...
      Height          =   600
      Left            =   315
      MouseIcon       =   "FormInputNumber.frx":2676
      MousePointer    =   99  'Custom
      TabIndex        =   15
      Top             =   4935
      Width           =   1905
   ...
   Begin VB.CommandButton CmdNumber0 
      ...
      Height          =   855
      Left            =   2415
      MouseIcon       =   "FormInputNumber.frx":27C8
      MousePointer    =   99  'Custom
      TabIndex        =   14
      Top             =   4725
      Width           =   1380
   ...
   Begin VB.CommandButton CmdNumber9 
      ...
      Height          =   855
      Left            =   3780
      MouseIcon       =   "FormInputNumber.frx":291A
      MousePointer    =   99  'Custom
      TabIndex        =   13
      Top             =   3885
      Width           =   1380
   ...
   Begin VB.CommandButton CmdNumber8 
      ...
      Height          =   855
      Left            =   2415
      MouseIcon       =   "FormInputNumber.frx":2A6C
      MousePointer    =   99  'Custom
      TabIndex        =   12
      Top             =   3885
      Width           =   1380
   ...
   Begin VB.CommandButton CmdNumber7 
      ...
      Height          =   855
      Left            =   1050
      MouseIcon       =   "FormInputNumber.frx":2BBE
      MousePointer    =   99  'Custom
      TabIndex        =   11
      Top             =   3885
      Width           =   1380
   ...
   Begin VB.CommandButton CmdNumber6 
      ...
      Height          =   855
      Left            =   3780
      MouseIcon       =   "FormInputNumber.frx":2D10
      MousePointer    =   99  'Custom
      TabIndex        =   10
      Top             =   3045
      Width           =   1380
   ...
   Begin VB.CommandButton CmdNumber5 
      ...
      Height          =   855
      Left            =   2415
      MouseIcon       =   "FormInputNumber.frx":2E62
      MousePointer    =   99  'Custom
      TabIndex        =   9
      Top             =   3045
      Width           =   1380
   ...
   Begin VB.CommandButton CmdNumber4 
      ...
      Height          =   855
      Left            =   1050
      MouseIcon       =   "FormInputNumber.frx":2FB4
      MousePointer    =   99  'Custom
      TabIndex        =   8
      Top             =   3045
      Width           =   1380
   ...
   Begin VB.CommandButton CmdNumber3 
      ...
      Height          =   855
      Left            =   3780
      MouseIcon       =   "FormInputNumber.frx":3106
      MousePointer    =   99  'Custom
      TabIndex        =   7
      Top             =   2205
      Width           =   1380
   ...
   Begin VB.CommandButton CmdNumber2 
      ...
      Height          =   855
      Left            =   2415
      MouseIcon       =   "FormInputNumber.frx":3258
      MousePointer    =   99  'Custom
      TabIndex        =   6
      Top             =   2205
      Width           =   1380
   ...
   Begin VB.CommandButton CmdNumber1 
      ...
      Height          =   855
      Left            =   1050
      MouseIcon       =   "FormInputNumber.frx":33AA
      MousePointer    =   99  'Custom
      TabIndex        =   5
      Top             =   2205
      Width           =   1380
...
'[] SPECIAL []
    ...
    Public Sub InputNumberFinish()
        If ((inputnumber1 * 1000 + inputnumber2 * 100 + inputnumber3 * 10 + inputnumber4) < 10) Or ((inputnumber1 * 1000 + inputnumber2 * 100 + inputnumber3 * 10 + inputnumber4) > 9999) Then
            MsgBox "CAUTION: Number invalid." & vbCrLf & "The quantity is limited, from 10 to 9999.", vbExclamation + vbOKOnly + vbDefaultButton1, "VoteHelper"
        Else
